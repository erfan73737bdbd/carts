...
const hint = document.querySelector(".intro-hint"); // این رو اول فایل کنار بقیه متغیرها بذار

async function startVideo() {
  if (started) return;
  started = true;

  // همین لحظه کلیک، نوشته محو بشه:
  if (hint) {
  ...
  try {
    ...
    // اگر به هر دلیلی مرورگر مانع شد، نوشته برگرده تا کاربر دوباره بزنه
    started = false;
